...
IMG_SIZE=640
BATCH_SIZE=8
MODEL_SIZE="n"  # nano model for faster training
yolo detect train model=yolo12m.yaml data="$YOLO_DATASET_DIR/dataset.yaml" epochs=$EPOCHS imgsz=$IMG_SIZE batch=$BATCH_SIZE
